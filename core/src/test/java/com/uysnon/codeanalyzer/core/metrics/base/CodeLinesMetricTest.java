...
public class CodeLinesMetricTest {
    CodeLinesMetric codeLinesMetric = new CodeLinesMetric();

    @DisplayName("Test process(Node node) method")
    @Test
    void testProcess(){
        ...
        codeLinesMetric.process(sourceCodeUnit.getCompilationUnit());
        Assertions.assertEquals(55, codeLinesMetric.getCount());
    }
