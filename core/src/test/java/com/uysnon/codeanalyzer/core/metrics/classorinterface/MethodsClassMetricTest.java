...
public class MethodsClassMetricTest {
    MethodsClassMetric methodsClassMetric = new MethodsClassMetric();
    ...
    void testProcess() {
        ...
        methodsClassMetric.process(sourceCodeUnit.getClassOrInterfaceUnits().get(0).getClassOrInterfaceDeclaration());
        Assertions.assertEquals(8, methodsClassMetric.getCount());
    }
