...
import ru.rsreu.gorkin.codeanalyzer.core.metrics.base.DoWhileStatementsMetric;
...
public class DoWhileStatementsMetricTest {
    DoWhileStatementsMetric metric = new DoWhileStatementsMetric();
