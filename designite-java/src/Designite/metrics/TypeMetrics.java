...
public class TypeMetrics implements MetricExtractor {
	...
	private int numOfNonStaticFinalPublicFields;
		...
		for (SM_Field field : type.getFieldList()) {
			...
			if (field.getAccessModifier() == AccessStates.PUBLIC) {
				...
				if (!(field.isStatic() && field.isFinal())) {
					numOfNonStaticFinalPublicFields++;
				}
				numOfPublicFields++;
			}
		}
	...
	public int getNumOfNonStaticFinalPublicFields() {
		return numOfNonStaticFinalPublicFields;
	}
