...
public class CountConstructorsCallingAbstractMethodReportUnit extends ReportUnit {
    public static final String CODE = "COUNT_CONSTRUCTORS_CALLiNG_ABSTRACT_METHOD";
    public static final String DESCRIPTION = "Максимальная глубина дерева наследования класса";

    public CountConstructorsCallingAbstractMethodReportUnit() {
        setCode(CODE);
