...
import ru.rsreu.gorkin.codeanalyzer.core.metrics.base.ABCMetric;
import ru.rsreu.gorkin.codeanalyzer.core.metrics.base.WhileStatementsMetric;
import ru.rsreu.gorkin.codeanalyzer.core.syntaxelements.SourceCodeUnit;

public class ABCMetricTest {
    ABCMetric metric = new ABCMetric();
    ...
    void testProcess() {
        ...
        Assertions.assertEquals(9, metric.getCount());
    }
