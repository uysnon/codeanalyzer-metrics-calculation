...
import ru.rsreu.gorkin.codeanalyzer.core.metrics.base.SwitchStatementsMetric;
import ru.rsreu.gorkin.codeanalyzer.core.syntaxelements.SourceCodeUnit;

public class SwitchStatementsMetricTest {
    SwitchStatementsMetric metric = new SwitchStatementsMetric();
