...
import ru.rsreu.gorkin.codeanalyzer.core.metrics.base.ForEachStatementsMetric;
...
public class ForEachStatementsMetricTest {

    ForEachStatementsMetric metric = new ForEachStatementsMetric();
    ...
    void testProcess() {
        ...
        Assertions.assertEquals(3, metric.getCount());
    }
